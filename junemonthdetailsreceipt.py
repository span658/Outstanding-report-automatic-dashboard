        ...
        <DESC>
            ...
            <TDL>
                <TDLMESSAGE>
                    ...
                    <SYSTEM TYPE="Formulae" NAME="OAIJune2025">
                        $$MonthOfDate:$Date = 6 AND $$YearOfDate:$Date = 2025
                    </SYSTEM>
...
print("\n" + "=" * 115)
print("JUNE 2025 RECEIPT DRILLDOWN")
print("=" * 115)
