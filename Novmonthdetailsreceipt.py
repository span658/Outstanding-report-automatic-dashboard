...
# =========================================
# XML REQUEST (NOVEMBER 2025 ONLY)
# =========================================
...
<ENVELOPE>
    <HEADER>
        ...
        <ID>OAIReceiptNovember2025Coll</ID>
    </HEADER>
    <BODY>
        <DESC>
            <STATICVARIABLES>
            ...
            <TDL>
                <TDLMESSAGE>
                    ...
                    <SYSTEM TYPE="Formulae" NAME="OAINovember2025">
                        $$MonthOfDate:$Date = 11 AND $$YearOfDate:$Date = 2025
                    </SYSTEM>
...
# OUTPUT
print("\n" + "=" * 115)
print("NOVEMBER 2025 RECEIPT DRILLDOWN")
print("=" * 115)
