...
# =========================================
# XML REQUEST (DECEMBER 2025 ONLY)
# =========================================
...
<ENVELOPE>
    <HEADER>
        ...
        <ID>OAIReceiptDecember2025Coll</ID>
    </HEADER>
    <BODY>
        <DESC>
            <STATICVARIABLES>
            ...
            <TDL>
                <TDLMESSAGE>
                    ...
                    <SYSTEM TYPE="Formulae" NAME="OAIDecember2025">
                        $$MonthOfDate:$Date = 12 AND $$YearOfDate:$Date = 2025
                    </SYSTEM>
...
# OUTPUT
print("\n" + "=" * 115)
print("DECEMBER 2025 RECEIPT DRILLDOWN")
print("=" * 115)
