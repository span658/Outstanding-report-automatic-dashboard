...
<ENVELOPE>
    <HEADER>
        ...
        <ID>OAIReceiptFebruary2026Coll</ID>
    </HEADER>
    <BODY>
        <DESC>
            <STATICVARIABLES>
            ...
            <TDL>
                <TDLMESSAGE>
                    ...
                    <SYSTEM TYPE="Formulae" NAME="OAIFebruary2026">
                        $$MonthOfDate:$Date = 2 AND $$YearOfDate:$Date = 2026
                    </SYSTEM>
...
for v in vouchers:
    ...
    # silently skip invalid date rows
...
print("\n" + "=" * 115)
print("FEBRUARY 2026 RECEIPT DRILLDOWN")
print("=" * 115)
