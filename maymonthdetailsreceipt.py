        ...
        <DESC>
            ...
            <TDL>
                <TDLMESSAGE>
                    ...
                    <SYSTEM TYPE="Formulae" NAME="OAIMay2025">
                        $$MonthOfDate:$Date = 5 AND $$YearOfDate:$Date = 2025
                    </SYSTEM>
...
print("\n" + "=" * 115)
print("MAY 2025 RECEIPT DRILLDOWN")
print("=" * 115)
