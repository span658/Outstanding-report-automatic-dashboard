        ...
        <DESC>
            ...
            <TDL>
                <TDLMESSAGE>
                    ...
                    <SYSTEM TYPE="Formulae" NAME="OAIApril2025">
                        $$MonthOfDate:$Date = 4 AND $$YearOfDate:$Date = 2025
                    </SYSTEM>
...
print("\n" + "=" * 115)
print("APRIL 2025 RECEIPT DRILLDOWN")
print("=" * 115)
