        ...
        <DESC>
            ...
            <TDL>
                <TDLMESSAGE>
                    ...
                    <SYSTEM TYPE="Formulae" NAME="OAIJuly2025">
                        $$MonthOfDate:$Date = 7 AND $$YearOfDate:$Date = 2025
                    </SYSTEM>
...
print("\n" + "=" * 115)
print("JULY 2025 RECEIPT DRILLDOWN")
print("=" * 115)
