...
# =========================================
# XML REQUEST (SEPTEMBER 2025 ONLY)
# =========================================
...
<ENVELOPE>
    <HEADER>
        ...
        <ID>OAIReceiptSeptember2025Coll</ID>
    </HEADER>
    <BODY>
        <DESC>
            <STATICVARIABLES>
            ...
            <TDL>
                <TDLMESSAGE>
                    ...
                    <SYSTEM TYPE="Formulae" NAME="OAISeptember2025">
                        $$MonthOfDate:$Date = 9 AND $$YearOfDate:$Date = 2025
                    </SYSTEM>
...
# OUTPUT
print("\n" + "=" * 115)
print("SEPTEMBER 2025 RECEIPT DRILLDOWN")
print("=" * 115)
