...
<ENVELOPE>
    <HEADER>
        ...
        <ID>OAIReceiptJanuary2026Coll</ID>
    </HEADER>
    <BODY>
        <DESC>
            <STATICVARIABLES>
            ...
            <TDL>
                <TDLMESSAGE>
                    ...
                    <SYSTEM TYPE="Formulae" NAME="OAIJanuary2026">
                        $$MonthOfDate:$Date = 1 AND $$YearOfDate:$Date = 2026
                    </SYSTEM>
...
# OUTPUT
print("\n" + "=" * 115)
print("JANUARY 2026 RECEIPT DRILLDOWN")
print("=" * 115)
