...
<ENVELOPE>
    <HEADER>
        ...
        <ID>OAIReceiptAugust2025Coll</ID>
    </HEADER>
    <BODY>
        <DESC>
            <STATICVARIABLES>
            ...
            <TDL>
                <TDLMESSAGE>
                    ...
                    <SYSTEM TYPE="Formulae" NAME="OAIAugust2025">
                        $$MonthOfDate:$Date = 8 AND $$YearOfDate:$Date = 2025
                    </SYSTEM>
...
for v in vouchers:
    ...
    ledger_entries = get_ledger_entries(v)
...
print("\n" + "=" * 115)
print("AUGUST 2025 RECEIPT DRILLDOWN")
print("=" * 115)
